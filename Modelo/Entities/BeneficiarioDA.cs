...
namespace CoBRA.Domain.Entities
{
    public class BeneficiarioDA
    {
        ...
        public List<NomeCapa> LstNomeCapa { get; set; }
        public string CpfCnpj { get; set; }
        public List<EmailAutorBeneficiario> LstEmail { get; set; }
        ...
        public List<AutorDA> LstAutores { get; set; }
        public List<LogAutorBeneficiario> LstLogAutorBeneficiario { get; set; }
    }
}
